...
* 编辑器
    ...
    * 分包
    * 分包优化
## Record Ignore  <a id="RecordIgnore"></a>
* 规定一些资源不记录到资源清单内
...
# 收集资源预览（Assets页签）
![Alt text](../../../Pic/Doc/WooAsset/assetstab.png)
...
![Alt text](../../../Pic/Doc/WooAsset/bundlestab.png)
